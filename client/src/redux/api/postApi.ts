    ...
    getAllPosts: builder.query<IPostResponse[], void>({
      ...
      providesTags: (result) =>
        result
          ...
          : [{ type: 'Posts', id: 'LIST' }],
      transformResponse: (results: { data: { posts: IPostResponse[] } }) => results.data.posts
    }),
...
export const { useCreatePostMutation, useDeletePostMutation, useUpdatePostMutation, useGetAllPostsQuery } = postApi
