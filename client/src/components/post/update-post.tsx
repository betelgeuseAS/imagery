import { Box, CircularProgress, TextareaAutosize, TextField, Typography } from '@mui/material'
    ...
    <Box>
      ...
      <FormProvider {...methods}>
        <Box component="form" noValidate autoComplete="off" onSubmit={methods.handleSubmit(onSubmitHandler)}>
          <TextField label="Title" fullWidth sx={{ mb: '1rem' }} focused {...methods.register('title')} />
          <TextField label="Category" fullWidth focused sx={{ mb: '1rem' }} {...methods.register('category')} />
          <Controller
            name="content"
